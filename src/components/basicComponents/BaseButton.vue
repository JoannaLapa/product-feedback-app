<template>
  <component
    ...
    :to="to"
    :type="type"
    class="flex min-h-7.5 place-items-center justify-center rounded-lg p-2.5 text-xxs font-bold text-neutral-300 transition duration-300 sm:h-11 sm:px-6 sm:text-xs"
    :class="{
