<template>
  ...
  <button
    ...
    :class="{
      ...
      'h-10 w-full bg-primary-200 text-neutral-300 hover:bg-secondary-600 sm:min-w-fit sm:px-6 md:text-sm':
        variant === 'primary',
      'h-10 w-full bg-neutral-500 text-neutral-300 hover:bg-neutral-900 sm:min-w-fit sm:px-6 md:text-sm':
        variant === 'dark',
    }"
