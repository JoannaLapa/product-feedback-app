...
<template>
  <main class="flex justify-center">
    <BaseWrapper variant="tertiary">
      ...
      <FeedbackItem2 :number="Number(route.params.id)">
        <template #heading>
          <h1
...
import FeedbackItem2 from "../../components/feedbacks/FeedbackItem2.vue";
...
const feedback = reactive(feedbacks.value[Number(route.params.id)]);
